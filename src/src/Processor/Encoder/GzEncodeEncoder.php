...
class GzEncodeEncoder implements EncoderInterface
{
    public const DECODE_MAX_LENGTH = 'gzdecode_max_length';
    public const ENCODE_ENCODING = 'gzencode_encoding';
    public const ENCODE_LEVEL = 'gzencode_level';
