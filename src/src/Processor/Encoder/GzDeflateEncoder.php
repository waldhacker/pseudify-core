...
class GzDeflateEncoder implements EncoderInterface
{
    public const DECODE_MAX_LENGTH = 'gzinflate_max_length';
    public const ENCODE_ENCODING = 'gzdeflate_encoding';
    public const ENCODE_LEVEL = 'gzdeflate_level';
