...
namespace Waldhacker\Pseudify\Core\Tests\Unit\Profile\Pseudonymize;

use PHPUnit\Framework\TestCase;
use Prophecy\PhpUnit\ProphecyTrait;
use Waldhacker\Pseudify\Core\Profile\Pseudonymize\MissingProfileException;
...
class ProfileCollectionTest extends TestCase
{
    ...
    public function testGetProfileThrowsExceptionIfProfileNotExists(): void
    {
        ...
        $this->expectExceptionCode(1621656965);
